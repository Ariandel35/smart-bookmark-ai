...
- 设置页隐私和支持按钮会在新建标签页失败时回退到窗口打开，并在两种方式都失败时显示页面内错误
...
- Settings Privacy and Support fall back from tab creation to window opening and show inline feedback if both paths are blocked
