...
11. If the information is insufficient, put it in ["Needs Manual Review"].`;
  ...
  const MESSAGES = {
    en: {
      ...
      popupSubtitle: "Remove obvious duplicates and dead links, then rebuild a simpler bookmark structure with AI.",
      popupStepConnect: "1. Open Settings and connect a model",
      popupStepPreview: "2. Run Preview to check the plan",
      popupStepOrganize: "3. Click Organize to apply it",
      optionsButton: "Settings",
      phaseIdle: "Idle",
      phasePreview: "Preview",
      startButton: "Organize",
      confirmOrganizeButton: "Confirm Organize",
      ...
      optionsSubtitle: "Connect a model once, preview the plan, then organize bookmarks in one flow.",
      ...
      settingsStepAccess: "Grant website access so the extension can check links and call your API.",
      ...
      setupRequiredTitle: "Set up your model first",
      setupRequiredDesc:
        "Open Settings, fill in provider, Base URL, model, and API key, then come back to Preview or Organize.",
      previewReadyConfirm:
        "Preview is ready. Start organizing now? The extension will rebuild the bookmark bar using this plan.",
    ...
    zh_CN: {
      popupPageTitle: "Smart Bookmark AI",
      popupMainTitle: "书签整理",
      popupSubtitle: "先清理明显重复和失效链接，再用 AI 重建更清晰的书签结构。",
      popupStepConnect: "1. 打开设置页并连接模型",
      popupStepPreview: "2. 先点预览查看整理方案",
      popupStepOrganize: "3. 确认后再点整理书签",
      optionsButton: "设置",
      phaseIdle: "空闲",
      phasePreview: "预览",
      startButton: "整理书签",
      confirmOrganizeButton: "确认整理",
      previewButton: "预览整理",
      backupButton: "手动备份",
      cancelButton: "取消任务",
      ...
      optionsSubtitle: "先连接模型，再预览方案，确认后再整理书签。",
      ...
      settingsStepAccess: "授权网站访问，这样插件才能检测链接并调用你的接口。",
      ...
      setupRequiredTitle: "先完成基础配置",
      setupRequiredDesc: "打开设置页，填写 Provider、Base URL、Model 和 API Key，然后再回来预览或整理。",
      previewReadyConfirm: "预览结果已经生成。现在开始正式整理吗？插件会按这个方案重建书签栏。",
