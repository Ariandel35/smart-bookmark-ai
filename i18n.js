...
11. If the information is insufficient, put it in ["Needs Manual Review"].`;
  ...
  const MESSAGES = {
    en: {
      ...
      supportOpenFailed: "Could not open support. Visit github.com/Ariandel35/marko/issues manually.",
      saveButton: "Save",
      resetButton: "Reset",
    ...
    zh_CN: {
      ...
      supportOpenFailed: "无法打开支持页面。请手动访问 github.com/Ariandel35/marko/issues。",
      saveButton: "保存设置",
      resetButton: "恢复默认",
      privacyButton: "隐私",
      supportButton: "支持",
