...
11. If the information is insufficient, put it in ["Needs Manual Review"].`;
  ...
  const MESSAGES = {
    en: {
      popupPageTitle: "TidyMarks AI",
      popupMainTitle: "TidyMarks",
      ...
      optionsPageTitle: "TidyMarks AI - Settings",
      optionsMeta: "TidyMarks AI / Options",
      ...
      privacyPageTitle: "TidyMarks AI - Privacy",
    ...
    zh_CN: {
      ...
      statDeleted: "已删除",
      statWarnings: "未处理",
      optionsPageTitle: "TidyMarks AI - 设置",
      optionsMeta: "TidyMarks AI / Options",
      optionsMainTitle: "设置",
      ...
      privacyPageTitle: "TidyMarks AI - 隐私说明",
