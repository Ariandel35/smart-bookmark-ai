...
11. If the information is insufficient, put it in ["Needs Manual Review"].`;
  ...
  const MESSAGES = {
    en: {
      ...
      hintBatchSize: "Use 5 to 100. Smaller batches are safer for slower models; DeepSeek runs at 5 automatically.",
    ...
    zh_CN: {
      ...
      organizeTitle: "规则",
      labelBatchSize: "批大小",
      hintBatchSize: "可填 5 到 100。慢模型建议使用更小批量；DeepSeek 会自动按 5 条一批运行。",
