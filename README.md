...
| Progress feedback | The popup shows elapsed time and, after real progress is available, an estimated remaining time. A lightweight once-per-second clock keeps that text fresh without reloading the full popup state every second. |
