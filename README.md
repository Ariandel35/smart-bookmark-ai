...
| Automation | Fast automatic organize can run locally without an API key; Balanced automatic organize needs model credentials; Complete automatic organize also requires website access, with a direct Silent organize switch showing the impact inline before saving. |
