...
- Slow-model timeout details now say Marko stopped waiting for the model request while the current run continues with local fallback, avoiding the misleading impression that the whole flow failed
